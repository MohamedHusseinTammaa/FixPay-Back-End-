...
export function htmlResetPasswordOtpTemp(otp){
    return `<!DOCTYPE html>
 ...
 <body style="margin: 0 !important; padding: 0 !important; background-color: #F7F3E8; font-family: Arial, sans-serif;">
     ...
     <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
         رمز إعادة تعيين كلمة المرور الخاص بك.
     </div>
                             ...
                             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                 ...
                                 <tr>
                                     <td align="center" style="font-family: 'Inter', Arial, sans-serif; font-size: 16px; line-height: 1.5; color: #4B5563; padding-bottom: 30px;">
                                         مرحباً،<br>
                                         لقد تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بك.<br>
                                         الرجاء استخدام رمز التحقق التالي:
                                     </td>
                                 </tr>
                                 <!-- كود الـ OTP -->
                                 <tr>
                                     <td align="center">
                                         <div style="background-color: #f3f4f6; border-radius: 12px; padding: 20px 30px; display: inline-block;">
                                             <p style="margin: 0; color: #DC2626; font-size: 36px; font-weight: bold; font-family: 'Inter', Arial, sans-serif; letter-spacing: 5px;">
                                 ...
                                 <tr>
                                     <td align="center" style="padding-top: 30px; font-family: 'Inter', Arial, sans-serif; font-size: 16px; line-height: 1.5; color: #4B5563;">
                                         هذا الرمز صالح لمدة <span style="font-weight: bold; color: #111827;">15 دقيقة</span>.
                                     </td>
                                 </tr>
                             </table>
                         </td>
